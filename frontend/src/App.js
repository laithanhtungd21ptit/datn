  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="teacher/rag-chat" element={<ProtectedRoute role="teacher"><RagChatPage /></ProtectedRoute>} />
        ...
        <Route path="student/rag-chat" element={<ProtectedRoute role="student"><RagChatPage /></ProtectedRoute>} />
        ...
        <Route path="admin/rag-chat" element={<ProtectedRoute role="admin"><RagChatPage /></ProtectedRoute>} />
