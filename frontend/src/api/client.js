...
export const api = {
  ...
  // RAG Chat APIs
  ragQuery: (payload) => apiRequest('/api/rag/query', { method: 'POST', body: JSON.stringify(payload) }),
  ragGetConversations: () => apiRequest('/api/rag/conversations'),
  ragGetConversation: (id) => apiRequest(`/api/rag/conversations/${id}`),
  ragDeleteConversation: (id) => apiRequest(`/api/rag/conversations/${id}`, { method: 'DELETE' }),
};
