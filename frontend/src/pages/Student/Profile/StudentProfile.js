                ...
                <FormControlLabel
                  control={
                    <Switch
                      ...
                      disabled={notificationSavingKey === 'assignmentDeadlines' || !notificationSettings.emailNotifications}
                    />
                  }
                ...
                <FormControlLabel
                  control={
                    <Switch
                      ...
                      disabled={notificationSavingKey === 'gradeUpdates' || !notificationSettings.emailNotifications}
                    />
                  }
                  label="Cập nhật điểm"
                  sx={{ opacity: notificationSettings.emailNotifications ? 1 : 0.5 }}
                ...
                <FormControlLabel
                  control={
                    <Switch
                      ...
                      disabled={notificationSavingKey === 'classAnnouncements' || !notificationSettings.emailNotifications}
                    />
                  }
